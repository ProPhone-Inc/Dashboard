...
export function BanListModal({ users,onClose }: BanListModalProps) {
  ...
  React.useEffect(() => {
    const loadBannedUsers = async () => {
      ...
      // console.log(...users.filter(user => user.reason))
      setBannedUsers([
        ...users.filter(user => user.reason)  // Only users with a 'reason' field
      ]);
      // setBannedUsers([
      //   {
