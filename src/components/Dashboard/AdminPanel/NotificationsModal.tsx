...
export function NotificationsModal({ onClose, onOpenEmailTemplates }: NotificationsModalProps) {
  ...
  useEffect(() => {
    const fetchusers = async () => {
      ...
      try {
        ...
        const ress = await axios.get("/api/auth/get-notifications", {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        });
        setNotificationLogs(ress.data.notifications)
  ...
  //     type: "warning",
  //     status: "failed",
  //     timestamp: "2025-04-12T19:15:02.123Z",
  //   },
  //   {
  //     id: "3",
  ...
  //     type: "announcement",
  //     status: "success",
  //     timestamp: "2025-04-09T09:45:30.000Z",
  //   },
  //   {
  //     id: "5",
  //     recipient: "li.wei@example.com",
  //     subject: "Security Alert",
  //     type: "warning",
  //     status: "failed",
  //     timestamp: "2025-04-08T17:20:00.000Z",
  //   },
  // ];
