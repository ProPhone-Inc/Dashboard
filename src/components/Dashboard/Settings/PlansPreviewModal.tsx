...
-
-const planIcons = {
-  starter: <Sparkles className="w-5 h-5 text-[#FFD700]" />,
-  pro: <Rocket className="w-5 h-5 text-[#FFD700]" />,
-  enterprise: <Crown className="w-5 h-5 text-[#FFD700]" />
-};
+export function PlansPreviewModal() {
+  return null;
+}